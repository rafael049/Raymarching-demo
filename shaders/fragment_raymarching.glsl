...
void main() {
	...
	objects[0].pos = vec4(0.0);

	objects[1].size = 1.0;
	objects[1].kind = 1;
	objects[1].material_id = 1;
	objects[1].pos = vec4(2.0, 1.0, 0.0, 1.0);

	objects[2].size = 1.0;
	objects[2].kind = 2;
	objects[2].material_id = 0;
	objects[2].pos = vec4(-2.0, 1.0, 0.0, 1.0);

	objects[3].size = 0.5;
	objects[3].kind = 2;
	objects[3].material_id = 1;
	objects[3].pos = vec4(0.0, 1.0, -3.0, 1.0);

	objects[4].size = 2.0;
	objects[4].kind = 1;
	objects[4].material_id = 2;
	objects[4].pos = vec4(0.0, 2.0, 3.0, 1.0);
